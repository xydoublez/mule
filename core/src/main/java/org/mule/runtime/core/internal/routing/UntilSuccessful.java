...
public class UntilSuccessful extends AbstractMuleObjectOwner implements Router {
  ...
  public void initialise() throws InitialisationException {
    ...
    String ownerName = this.getLocation().getRootContainerName();
    flowConstruct = (FlowConstruct) componentLocator.find(Location.builder().globalName(ownerName).build()).get();
  }
