...
public class BasicAuthWsdlFunctionalTestCase extends AbstractWSConsumerFunctionalTestCase
{
    ...
    protected void doSetUpBeforeMuleContextCreation() throws Exception
    {
        ...
        UserStore loginServiceUserStore = new UserStore();
        loginServiceUserStore.addUser("user", new Password("password"), new String[] {"user"});
        loginService.setUserStore(loginServiceUserStore);
