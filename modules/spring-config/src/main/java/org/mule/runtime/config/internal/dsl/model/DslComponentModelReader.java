...
public class DslComponentModelReader {
  ...
  public ComponentModel extractComponentDefinitionModel(ConfigFile configFile) {
    ...
    ComponentModel componentModel = builder.setConfigFileName("zaraza").build();
  ...
  private ComponentModel createModel(FlowDefinition flowDefinition) {
    ...
    return extractComponentDefinitionModel("zaraza", flowDefinition, "flow", attributes);
  }
  ...
  public ComponentModel extractComponentDefinitionModel(String configFileName, EObject eObject, String elementIdentifier,
