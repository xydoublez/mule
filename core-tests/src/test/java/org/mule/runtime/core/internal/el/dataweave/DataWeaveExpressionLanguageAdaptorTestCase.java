...
import static org.mule.runtime.api.el.BindingContextUtils.GROUP_CORRELATION;
...
public class DataWeaveExpressionLanguageAdaptorTestCase extends AbstractWeaveExpressionLanguageTestCase {
  ...
  public void groupCorrelationBinding() throws Exception {
    ...
    TypedValue result = expressionLanguage.evaluate(GROUP_CORRELATION, event, BindingContext.builder().build());
