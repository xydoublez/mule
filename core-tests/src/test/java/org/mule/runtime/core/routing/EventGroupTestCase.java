...
public class EventGroupTestCase extends AbstractMuleContextTestCase {
  ...
  public void concurrentIteration() throws Exception {
    ...
    eg.addEvent(eventBuilder().muleContext(muleContext).message(Message.of("foo1")).build());
    eg.addEvent(eventBuilder().muleContext(muleContext).message(Message.of("foo2")).build());
    assertTrue(eg.iterator().hasNext());

    // now add events while we iterate over the group
    Iterator<Event> i = eg.iterator();
    assertNotNull(i.next());
    eg.addEvent(eventBuilder().muleContext(muleContext).message(Message.of("foo3")).build());
    assertNotNull(i.next());
    eg.addEvent(eventBuilder().muleContext(muleContext).message(Message.of("foo4")).build());
  ...
  public void eventGroupConversionToString() throws Exception {
    ...
    Event firstEvent = eventBuilder().muleContext(muleContext).message(Message.of("foo")).build();
    ...
    Event secondEvent = eventBuilder().muleContext(muleContext)
  ...
  public void mergedSessions() throws Exception {
    ...
    Event event1 = eventBuilder().muleContext(muleContext).message(Message.of("foo1")).build();
    Event event2 = eventBuilder().muleContext(muleContext).message(Message.of("foo2")).build();
    Event event3 = eventBuilder().muleContext(muleContext).message(Message.of("foo3")).build();
